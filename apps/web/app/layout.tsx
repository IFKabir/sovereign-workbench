        ...
        <AuthGuard>
          ...
          <aside className="w-64 glass-panel border-r border-sovereign-border flex flex-col z-10 h-screen sticky top-0 shrink-0">
            ...
            <nav className="flex-1 py-4 px-3 space-y-1">
              ...
              <Link href="/schematic" className="flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-300 hover:bg-sovereign-surface hover:text-white transition-colors text-sm">
